...
const SURVEY_UI_TEXT: Record<SurveyLocale, SurveyUiText> = {
  ...
  tr: {
    sectionTitles: {
      social: "1. Sosyal Enerji ve Etkilesim",
      openness: "2. Aciklik ve Kulturel Merak",
      planning: "3. Planlama ve Yasam Tarzi",
      party: "4. Sosyal Aktivite ve Parti Tarzi",
      daily: "5. Gunluk Ritim",
      travel: "6. Seyahat ve Kesif",
      communication: "7. Iletisim ve Konfor",
    },
    sectionQuestions: {
      social: [
        "Yeni insanlarla kolayca konusma baslatirim.",
        "Kalabalik sosyal gruplarda bulunmaktan hoslanirim.",
        "Sosyal etkilesimlerden sonra enerji kazanirim.",
        "Grupla vakit gecirmek yerine yalniz kalmayi tercih ederim.",
        "Grup aktivitelerine aktif katilirim.",
        "Farkli gecmislere sahip yeni insanlarla tanismayi severim.",
        "Ilgi odagi olmaktan rahatsiz olmam.",
        "Genelde once digerlerinin yaklasmasini beklerim.",
      ],
      openness: [
        "Yeni kulturleri deneyimlemek beni heyecanlandirir.",
        "Alisilmadik yemekleri denemeyi severim.",
        "Farkli bakis acilarini ogrenmekten hoslanirim.",
        "Bilinmeyen ortamlarda rahatsiz hissederim.",
        "Yeni durumlara hizli uyum saglarim.",
        "Konfor alanimin disina cikmaktan keyif alirim.",
        "Diger ulkelerde insanlarin nasil yasadigini merak ederim.",
      ],
      planning: [
        "Gunu net bir planla gecirmeyi tercih ederim.",
        "Planlar aniden degistiginde strese girerim.",
        "Aktiviteleri onceden organize etmeyi severim.",
        "Spontane kararlar almaktan keyif alirim.",
        "Dakik olmak benim icin cok onemlidir.",
        "Esnek takvim yerine yapilandirilmis programlari tercih ederim.",
        "Beklenmedik degisikliklere kolayca uyum saglarim.",
      ],
      party: [
        "Gece hayati ve partilerden hoslanirim.",
        "Yuksek enerjili sosyal ortamlari severim.",
        "Sakin ve sessiz aktiviteleri tercih ederim.",
        "Dans etmeyi veya hareketli sosyal etkinlikleri severim.",
        "Gurultulu ortamlarda rahat hissederim.",
        "Partiler yerine derin sohbetleri tercih ederim.",
      ],
      daily: [
        "Sabah saatlerinde daha verimli olurum.",
        "Gec saatlere kadar ayakta kalmaktan hoslanirim.",
        "Gune erken baslamayi tercih ederim.",
        "Gec saatlerde daha aktif hissederim.",
      ],
      travel: [
        "Hizli tempolu seyahat planlarini tercih ederim.",
        "Bir gunde birden fazla yeri kesfetmekten hoslanirim.",
        "Daha az aktiviteyle rahat tempoda gezmeyi tercih ederim.",
      ],
      communication: [
        "Ingilizce iletisime girerken kendime guvenirim.",
        "Yeni insanlarla derin sohbetleri severim.",
        "Sohbeti kolayca surdurebilirim.",
        "Konusmaktan cok dinlemeyi tercih ederim.",
      ],
    },
    forcedChoiceText: {
      planningStyle: {
        title: "Seni hangisi daha iyi anlatir?",
        options: {
          plan_flexible: "Onceden plan yaparim ama esnek kalabilirim",
          spontaneous_plan: "Spontaneyim ama gerektiginde plan yaparim",
        },
      },
      buddyPriority: {
        title: "Bir buddyde hangisi daha onemli?",
        options: {
          fun_social: "Eglenceli ve sosyal",
          calm_reliable: "Sakin ve guvenilir",
        },
      },
      idealActivity: {
        title: "Ideal aktivite secimi",
        options: {
          party_social: "Parti / Sosyal",
          cultural_museum: "Kulturel / Muze",
          mixed: "Karisik",
        },
      },
      timeStyle: {
        title: "Tercih edilen zaman duzeni",
        options: {
          early_bird: "Erken uyur / erken kalkar",
          night_owl: "Gec uyur / gece aktif",
        },
      },
    },
    likertLabels: ["Kesinlikle katilmiyorum", "Katilmiyorum", "Kararsizim", "Katiliyorum", "Kesinlikle katiliyorum"],
    likertTitle: "Likert Olcegi",
    likertLegend: "1 = Kesinlikle katilmiyorum, 5 = Kesinlikle katiliyorum",
    forcedChoiceHeading: "8. Zorunlu Secim",
    travelPrompt: "Program sonrasinda seyahat etmek istiyorum.",
    yesLabel: "Evet",
    noLabel: "Hayir",
    scoreLabels: {
      social: "Sosyal",
      openness: "Aciklik",
      flexStructure: "Esneklik / Yapi",
      partyCommunication: "Parti / Iletisim",
    },
    wizard: {
      title: "Adim 1: Buddy Matcher Sorulari",
      subtitle: "Uyum profilini olusturmak icin tum zorunlu sorulari cevapla.",
      back: "Geri",
      next: "Sonraki Bolum",
      continueToProfile: "Profile Gec",
      completeProfile: "Profili Tamamla",
      progress: "Ilerleme",
      profileTitle: "Adim 2: Herkese Acik Profilini Tamamla",
      profileSubtitle: "Katilimcilara katilmadan once fotografin, bio'n ve sosyal linklerini ekle.",
      profileCountry: "Ulke",
